...
$(window).scroll(function() {
        $(".navbar").length && ($(".navbar").offset().top > OFFSET_TOP ? $(".scrolling-navbar").addClass("top-nav-collapse") && $('.scrolling-navbar').removeClass('bg-gradient') && $('img[src="img/svg/cc-icon-white.svg"]').attr('src', 'img/svg/cc-icon.svg'): $(".scrolling-navbar").removeClass("top-nav-collapse") && $(".scrolling-navbar").addClass("bg-gradient") && $('img[src="img/svg/cc-icon.svg"]').attr('src', 'img/svg/cc-icon-white.svg'))
    }),
    function(e, t) {
        "use strict";
